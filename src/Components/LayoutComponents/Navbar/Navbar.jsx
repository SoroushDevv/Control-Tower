...
export default function Login() {
  ...
  return (
    ...
    >
      <div className="w-full h-20 px-3 pt-2 flex justify-between items-center gap-3 border-light-border bg-light-bg-surfaceAlt text-light-text-primary dark:bg-dark-bg-surfaceAlt dark:text-dark-text-primary dark:border-dark-border  border-2 rounded-md">
