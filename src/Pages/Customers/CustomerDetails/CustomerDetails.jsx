        ...
        <div className="relative w-full h-screen">
            <div className="w-full flex justify-between items-start p-2">
                <div className="w-full">
                    ...
                    <div className="flex justify-between items-stretch gap-2 h-[465px]">
                        {/* profile section */}
                        <div className="flex basis-2/5 h-full shadow-md border border-dark-border-light rounded-xl">
                            <div className="w-full flex flex-col justify-between items-center py-3 px-4 divide-y-2 divide-dark-border-light-10 dark:divide-light-border space-y-2">
                                <div className="w-full flex flex-col justify-between items-start gap-2 ">
                                    <div className="w-full flex justify-between items-start gap-2">
                                        ...
                                        <div className="size-7 flex justify-center items-center rounded-md hover:bg-gray-200">
                        ...
                        {/* payment section */}
                        <div className="flex basis-3/5 shadow-md border border-dark-border-light rounded-xl h-[465px]">
                            <div className="w-full h-full flex flex-col justify-start items-center py-3 px-4 gap-4">
                                ...
                                {/* user overview */}
                                <div className="w-full flex justify-between items-center divide-x-2 divide-gray-500 border border-dark-border rounded-xl p-4">
                ...
                {/* <div className="flex basis-1/3 flex-col justify-start items-start border-2 border-slate-500">
                    ...
                    <div className="flex justify-start items-center gap-2 p-2">
                        ...
                        <span className="date">18/4/1400</span>
                    </div>
                    <div className="flex justify-start items-center gap-2 p-2">
                        <span className="ct-subtitle">نام:</span>
                        <span className="name">علی </span>
                    </div>
                    <div className="flex justify-start items-center gap-2 p-2">
                        <span className="ct-subtitle">نام خانوادگی:</span>
                        <span className="lastname">عظیمی</span>
                    </div>
                    <div className="flex justify-start items-center gap-2 p-2">
                        <span className="ct-subtitle">ایمیل:</span>
                        <span className="email">aliAzimi@gmail.com</span>
                    </div>
                    <div className="flex justify-start items-center gap-2 p-2">
                        <span className="ct-subtitle">شماره:</span>
                        <span className="phone">09174675367</span>
                    </div>
                    <div className="flex justify-start items-center gap-2 p-2">
                        <span className="ct-subtitle">شهر:</span>
                        <span className="city">شیراز</span>
                    </div>
