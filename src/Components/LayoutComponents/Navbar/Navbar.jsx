...
export default function Login() {
  ...
  return (
    <motion.div
      ...
      className="w-full h-fit flex justify-center items-center border-2 rounded-lg divide-x-2 divide-dark-border"
    >
      <div className="w-full h-20 px-3 py-2 flex justify-between items-center gap-3 border-2 rounded-md border-light-border bg-light-bg-base text-light-text-primary dark:bg-dark-bg-surface dark:text-dark-text-primary dark:border-dark-border">
        <div className="flex basis-2/6 h-full justify-start items-center gap-3 border-light-border-light bg-transparent text-light-text-primarySoft dark:text-dark-text-primarySoft dark:border-dark-border-light">
          ...
          <div className="relative h-full w-auto p-2 flex justify-center items-center border- ">
