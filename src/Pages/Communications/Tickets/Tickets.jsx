...
export default function Tickets() {
    const tickets = [
        {
            ...
            lastName: "مرادی",
            role: "مدیر",
            message: "این پیام مربوط به اطلاعیه مهم است.ین پیام مربوط به اطلاعیه مهم است. ین پیام مربوط به اطلاعیه مهم است. ین پیام مربوط به اطلاعیه مهم است.ین پیام مربوط به اطلاعیه مهم است.",
            read: true,
            avatarUrl: "",
    ...
    return (
        <div className="grid grid-cols-2 gap-3  mx-auto p-4  dark:bg-dark-bg-surface dark:text-light-bg-surface overflow-hidden overflow-y-auto scrollbar-hide" dir="rtl">
            {tickets.map((ticket) => (
                <div key={ticket.id} className={`flex flex-col justify-between items-start gap-4 p-4 rounded-lg border ${ticket.read ? "bg-gray-50" : "bg-white shadow-md"}  dark:bg-dark-bg-surface dark:text-light-bg-surface dark:border-dark-border-light dark:hover:border-dark-border-focus transition-shadow duration-200 ease-in-out cursor-pointer`}>
